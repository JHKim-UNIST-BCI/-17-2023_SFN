...
class SNNModel(nn.Module):
    ...
    def process_stim(self,
        ...
        for i in range(1, stim_len):
            ...
            SA_layers[2].update(SA_rf_input_PN1 * 4 - SA_rf_input_PN2 * 3)
            ##############################################################
            ...
            RA_layers[2].update(RA_rf_input_PN1 * 4 - RA_rf_input_PN2 * 3)
            ##############################################################
            ...
            CN_layers[1].update((CN_PN_SA_rf_input +
                                CN_PN_RA_rf_input_resized) * 5 - CN_IN_rf_input * 3)
            ##############################################################
